...
# Ensure the sequences have three dimensions
if len(X_3.shape) == 3 and len(y_3.shape) == 2:
    X_3_scaled, y_3_scaled = scale_sequences(X_3, y_3)
if len(X_4.shape) == 3 and len(y_4.shape) == 2:
    X_4_scaled, y_4_scaled = scale_sequences(X_4, y_4)
if len(X_5.shape) == 3 and len(y_5.shape) == 2:
    X_5_scaled, y_5_scaled = scale_sequences(X_5, y_5)
if len(X_6.shape) == 3 and len(y_6.shape) == 2:
